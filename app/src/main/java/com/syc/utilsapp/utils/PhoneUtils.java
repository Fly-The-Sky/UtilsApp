...
public class PhoneUtils {
    ...
    public static void dial(String phoneNumber) {
        getContext().startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(String phoneNumber) {
        getContext().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        getContext().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        if (StringUtils.isEmpty(content))
            return;
        PendingIntent sentIntent = PendingIntent.getBroadcast(getContext(), 0, new Intent(), 0);
